...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get("/item/").subscribe(function (data) {
            console.log("get response:" + JSON.stringify(data));
            _this.model.items = data;
        });
    };
    ...
    AppComponent.prototype.addItem = function (newItem) {
        if (newItem != "") {
            this.http.post("/item/", new _model__WEBPACK_IMPORTED_MODULE_1__["TodoItem"](newItem, false)).subscribe(function (data) {
                console.log("POST Request is successful ", data);
            });
            this.model.items.push(new _model__WEBPACK_IMPORTED_MODULE_1__["TodoItem"](newItem, false));
        }
    };
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"]
            ],
            providers: [],
...
module.exports = __webpack_require__(/*! C:\Fang\Todo\todoangular\src\main.ts */"./src/main.ts");
